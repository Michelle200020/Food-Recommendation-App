...
def home(request):
    ...
    welcome_message = "Welcome to the Nutrition App!"
    introduction = "This app is designed to help you explore nutritional information for various foods."
    made_by = "Made by Michelle Miranda from 3BSC DS."
...
def data_tab(request):
    ...
    df = pd.read_csv("C:\\Users\\miche\\OneDrive\\Desktop\\Christ University- Bsc Data Science\\Semester 3\\Data Analytics\\NUTRITION APP\\Cleaned_Ingredients.csv")
...
def recommend_food(request):
    if request.method == 'POST':
        ...
        file_path ="C:\\Users\\miche\\OneDrive\\Desktop\\Christ University- Bsc Data Science\\Semester 3\\Data Analytics\\NUTRITION APP\\Cleaned_Ingredients.csv"
